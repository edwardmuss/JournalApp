...
// options specified by gso.
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        continueBtn = (Button)v.findViewById(R.id.continue_button);
        ...
        imgProfilePic.setImageBitmap(ProfileImageHelper.getRoundedCornerBitmap(getContext(),icon, 200, 200, 200, false, false, false, false));
...
private void OpenMainActivity(){
    Toast.makeText(getActivity(), "Redirecting", Toast.LENGTH_LONG).show();
    ...
    public class LoadProfileImage extends AsyncTask<String, Void, Bitmap> {
        ...
        protected void onPostExecute(Bitmap result) {
            ...
            if (result != null) {
                ...
                bmImage.setImageBitmap(ProfileImageHelper.getRoundedCornerBitmap(getContext(),resized,250,200,200, false, false, false, false));
